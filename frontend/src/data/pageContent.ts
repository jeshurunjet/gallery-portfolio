export type AboutStrengthIcon = "code" | "palette" | "heart" | "rocket";

export type AboutStrength = {
  title: string;
  icon: AboutStrengthIcon;
  text: string;
};
...
export type ResumeContactIcon = "map" | "mail" | "phone" | "code";
...
export type ResumeContent = {
  ...
  quickCardLabel: string;
  quickCardText: string;
  profile: string;
...
export const defaultAboutContent: AboutContent = {
  ...
  heroTitle: "Full-stack developer with a designer's eye.",
  heroParagraphs: [
  ...
  focusText:
    "Completing a Level 8 Diploma in Computer Science at AUT while building web projects for businesses, community groups, and my own portfolio.",
  focusAreas: [
  ...
  statement:
    "My work sits between design and engineering. I can plan interfaces, create assets, build responsive front ends, connect data, and deploy projects. I also bring a service mindset from support work: clear communication, patience, documentation, and care for the people using the final product.",
  strengths: [
    {
      title: "Build",
      icon: "code",
  ...
  experienceTitle: "Creative, technical, and people-focused work.",
  experienceText:
    "I have worked as a web developer, full-stack developer, front-end developer, graphic designer, video-photographer, and support worker. That background gives me a broad view of digital projects: how they look, how they work, how they are maintained, and how they support real people.",
};
...
export const defaultResumeContent: ResumeContent = {
  ...
  name: "Jesh Sanchez",
  summary:
    "Web and cloud development professional with experience in full-stack development, front-end engineering, UI design, graphic design, and digital solutions.",
  contactLinks: [
    {
  ...
  quickCardLabel: "Open full CV",
  quickCardText: "Currently completing a Level 8 Diploma in Computer Science at AUT.",
  profile:
    "After several years in disability support work, I am transitioning back into IT to gain professional experience in web development and software engineering. I bring experience supporting clients, coordinating with healthcare professionals, and delivering web solutions in small teams.",
  skillGroups: [
    {
      title: "Web",
      skills: [
